# ADC reading battery voltage

The Adafruit feather RP2040 has an on-board battery connector. The battery's voltage is mirrored on pun `BAT` and can be connected to one of the ADC's inputs via a double-100k resistor voltage divider.
